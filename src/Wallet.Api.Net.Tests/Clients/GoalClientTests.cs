...
{
    public class GoalClientTests
    {
        [Test]
        public async Task GetAsync_WhenResponseIsSuccessful_ReturnsSuccess()
        {
            var client = new GoalClient(ClientTestHelpers.CreateHttpClient((_, _) =>
            ...
            Result<GetGoalsResponse> result = await client.GetAsync(new GetGoalsRequest { Limit = 10, Offset = 0 });
        ...
        public async Task GetAsync_WhenRequestIsNull_ReturnsFailedResult()
        {
            ...
            Result<GetGoalsResponse> result = await client.GetAsync(null!);
        ...
        public async Task GetAsync_WhenApiReturnsNonSuccessStatus_PropagatesStatusCodeInErrorMetadata(HttpStatusCode statusCode)
        {
            ...
            Result<GetGoalsResponse> result = await client.GetAsync(new GetGoalsRequest { Limit = 1, Offset = 0 });
        ...
        public void GetAsync_WhenApiReturnsInvalidJson_ThrowsJsonException()
        {
            ...
            Assert.That(async () => await client.GetAsync(new GetGoalsRequest { Limit = 1, Offset = 0 }), Throws.TypeOf<JsonException>());
        }
    }
}
