...
namespace Wallet.Api.Net.Tests
{
    public class ResponseDtosJsonDeserializationTests
    {
        ...
        private static IEnumerable<TestCaseData> ResponseDtoJsonCases()
        {
            ...
            yield return CreateCase("Account real", BuildJsonPath("Account", "GetAccountsResponseDto.real.json"), typeof(GetAccountsResponseDto), "Accounts", 3);
            ...
            yield return CreateCase("Budget real", BuildJsonPath("Budget", "GetBudgetsResponseDto.real.json"), typeof(GetBudgetsResponseDto), "Budgets", 0);
            ...
            yield return CreateCase("Category real", BuildJsonPath("Category", "GetCategoriesResponseDto.real.json"), typeof(GetCategoriesResponseDto), "Categories", 30);
            ...
            yield return CreateCase("Goal real", BuildJsonPath("Goal", "GetGoalsResponseDto.real.json"), typeof(GetGoalsResponseDto), "Goals", 0);
            ...
            yield return CreateCase("Label real", BuildJsonPath("Label", "GetLabelsResponseDto.real.json"), typeof(GetLabelsResponseDto), "Labels", 1);
            ...
            yield return CreateCase("RecordRule real", BuildJsonPath("RecordRule", "GetRecordRulesResponseDto.real.json"), typeof(GetRecordRulesResponseDto), "RecordRules", 0);
